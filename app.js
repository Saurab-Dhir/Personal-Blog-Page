...
app.get('/posts/:pageTitle', function(req, res) {
  ...
  allPosts.forEach(function(compose) {
    ...
    const storedTitle = _.lowerCase(compose.title );
    if (storedTitle === requestedTitle) {  // stored title and requested title are in the format of KebabCasing ex: Day 1 = day-1
      console.log("Match found");
      res.render("post.ejs", {pageTitle: compose.title, fullContent: compose.post});
    } else {
